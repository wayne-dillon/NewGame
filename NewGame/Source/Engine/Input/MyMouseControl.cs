...
public class MyMouseControl
{
    ...
    {
        if (newMouse.LeftButton == ButtonState.Pressed && oldMouse.LeftButton != ButtonState.Pressed && newMouse.Position.X >= 0 && newMouse.Position.X <= Coordinates.screenWidth && newMouse.Position.Y >= 0 && newMouse.Position.Y <= Coordinates.screenHeight)
        {
            return true;
        }
    ...
    {
        if (newMouse.RightButton == ButtonState.Pressed && oldMouse.RightButton != ButtonState.Pressed && newMouse.Position.X >= 0 && newMouse.Position.X <= Coordinates.screenWidth && newMouse.Position.Y >= 0 && newMouse.Position.Y <= Coordinates.screenHeight)
        {
            return true;
        }
